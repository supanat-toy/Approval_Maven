                                ...
                                <div class="col_percent_8 set_padding_right_15 set_padding_right_15">
                                    <form action="#" method="POST" data-parsley-validate="true">
                                        <div class="form_group_row">
                                            ...
                                            <input name="event_name" class="form_control_textField" value="${formDetails.event_name}" data-parsley-required="true">
                                        </div>
                                        <div class="form_group_row">
                                            <div class="col_percent_7 set_padding_right_15">
                                                <label>Job Function / Activities</label>
                                                <input name="event_type" class="form_control_textField" value="${formDetails.activity}" data-parsley-required="true">
                                            </div>
                                            <div class="col_percent_5">
                                                <label>Faculty / Department</label>
                                                <input name="event_department" class="form_control_textField" value="${formDetails.department}" data-parsley-required="true">
                                            </div>
                                        </div>
                                        <div class="form_group_row">
                                            <label>Place</label>
                                        ...
                                        <div class="form_group_row">
                                            <div class="col_percent_7 set_padding_right_15">
                                                ...
                                                <input name="event_name" value="${formDetails.coordinator_name}" class="form_control_textField" data-parsley-required="true">
                                            </div>
                                            <div class="col_percent_5">
                                                <label>Coordinator phone</label>
                                                <input name="event_name" value="${formDetails.coordinator_phone_number}" class="form_control_textField" data-parsley-required="true">
                                            </div>
                                        </div>
                                        <div class="form_group_row">
                                            <label>Description</label>
                                            <textarea name="description" value="${formDetails.description}" class="form_control_textField"></textarea>
                                        </div>
